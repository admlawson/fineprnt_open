...
serve(async (req) => {
  ...
  try {
    ...
    const inviteResult = await supabaseAdmin.auth.admin.inviteUserByEmail(email, {
      ...
      redirectTo: `${Deno.env.get('SITE_URL') || 'https://www.fineprnt.com'}/auth/complete-invite`
    });
